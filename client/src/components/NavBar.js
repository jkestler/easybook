    ...
    return (
      ...
      this.props.loggedIn ? (
        ...
        <nav className='navbar navbar-expand-lg fixed-top' >
          <Link to='/bookmarks' className='navbar-brand'><img id='logoutLogo' src={logoLogout} alt='logo' /></Link>
        ...
        <nav className='navbar navbar-expand-lg fixed-top' >
          <Link to='/' className='navbar-brand'><img id='logoutLogo' src={logoLogout} alt='logo' /></Link>
...
{/* <nav className='navbar mr-3' id='navBar'>
  <Link href='/' className='navbar-brand'><img id='logoutLogo' src={logoLogout} alt='logo' /></a>
...
<nav className='navbar mr-3' id='navBar'>
  <Link href='/bookmarks' className='navbar-brand mt-4'><img id='loginLogo' src={logo} alt='logo' /></a>
